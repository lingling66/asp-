<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dingdan.aspx.cs" Inherits="admin_dingdan" %>
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="shangpingname" HeaderText="商品名称"></asp:BoundColumn>
                                   <asp:BoundColumn DataField="totalprice" HeaderText="总价格"></asp:BoundColumn>
