...
public class users
	{
		...
		public int users_add()
		{
			...
			return 	dbconn.updata("users_add",para);			
		}
		public SqlDataReader users_denlu()
		{
			...
			return dbconn.getread("users_denlu",para);
		...
		public int users_del()
		{
			...
			para[0].Value = userid;
			return dbconn.updata("users_del",para);
		}
		public DataSet users_sel()
		{
			return dbconn.getdataset("users_sel",null);
		}
		...
		public int users_update()
		{
            ...
            return dbconn.updata("users_update",para);			
